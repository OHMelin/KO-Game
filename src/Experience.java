...
public class Experience {
	...
	//Display exp bar
	/*
	 * String full is the full string we wish to return. I start by adding a start, then for every time i < currentExp/10 i print |
	 * If current exp is 60 it will print 6 characters
